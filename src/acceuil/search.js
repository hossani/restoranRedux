...
function Search() {
    ...
    const prevPage=useSelector((state)=>state.pagination.prevPage);
    ...
    if(searchTerm==''){
        ...
        dispatch( setFilteredArticles(
            articles.filter((article)=>article.titre.toLowerCase().includes(searchTerm.toLowerCase()))
        ));
